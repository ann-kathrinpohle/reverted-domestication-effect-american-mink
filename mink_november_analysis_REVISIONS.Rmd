...
Former Figure 2 is now Supplementary Figure S3
...
the following chunk has the code for figure one including revisions. the only difference are the asterisks which have changed due to p-value differences in results of the pairwise comparisons.
...
```{r figure two}
setwd("/Users/ankapohle/Desktop")
vol_models <- read_delim("vol_models_REVISED.csv",",", escape_double = FALSE, trim_ws = TRUE, locale=locale(decimal_mark = "."))
